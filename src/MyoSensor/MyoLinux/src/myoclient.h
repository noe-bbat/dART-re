...
public:
    ...
    void connect(const Address &,std::chrono::seconds timeout = std::chrono::seconds(30));
    void connect(const std::string &,std::chrono::seconds timeout = std::chrono::seconds(30));
    void connect(std::chrono::seconds timeout = std::chrono::seconds(30));
    bool connected();
    Address address();
    void disconnect();
