...
class MyoSensorDatabase:
    ...
    def display_data(self, df, file_name,csv_file):
        """
        ...
        if st.checkbox("Get Real Time Data"):
                ...
                while (1):
                     if (csv_file):
                         ...
                         try:
                             ...
                             logging.debug(f"UDP error: {str(e)}")
        ...
        try:
            ...
            for tab, csv_file in zip(tabs, csv_files):
                with tab:
                    ...
                    self.display_data(df, csv_file.name,csv_file)
